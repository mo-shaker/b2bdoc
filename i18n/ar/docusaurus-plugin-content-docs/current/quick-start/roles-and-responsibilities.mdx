...
| المستودع | تجهيز البضائع وتهيئتها، وتأكيد الجاهزية، وتحميل المركبة |
| المخطِّط / المُوزِّع | توليد الخطة اليومية ومراجعتها، ومعالجة الطلب غير المخطط |
| مدير العمليات | مراجعة الخطة واعتمادها والإفراج عنها |
| السائق | تنفيذ الرحلة وتسجيل نتيجة التسليم |
...
| Planner / Dispatcher وOperations Manager | **Inventory → User** و**Fleet → Officer** |

وبدونها يُظهر نموذج الطلب ومعالج التخطيط خطأ `Access Error`. راجع [حدود الإصدار الأول](./release-1-boundaries.mdx).
