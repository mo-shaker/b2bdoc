...
:::warning[اختبار الانحراف يغطي الحالات والانتقالات، لا الآثار اللاحقة]

جداول **الانتقالات ذات الآثار اللاحقة** أدناه نصٌّ من المواصفة نفسها، والنصّ ليس ما يقارنه اختبار الانحراف. فيمكن أن يكون الأثر مُواصَفاً وغير مُنفَّذ، ويمرّ البناء مع ذلك.

وواحدٌ منها كذلك، وهو مهم: **«follow-up demand created»** — على انتقال الرحلة `in_progress → partially_completed`، وعلى انتقالَي الطلب `in_execution → partially_completed` و`in_execution → failed` — **لا يحدث في الإصدار الأول**. فلا شيء يكتب `parent_demand_id`، والطلب غير المُلبّى بالكامل لا يغادر `in_execution` أبداً.

اقرأ جداول الآثار في هذه الصفحة على أنها **ما هو مُواصَف**، واقرأ [استكمال الطلب](../demand/demand-completion.mdx) لما هو مُتحقَّق منه.
