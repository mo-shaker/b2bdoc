...
| **Partially Completed** | سُلِّم بعضه وبقي بعضه | طلب متابعة — **لا يُنشأ في الإصدار الأول** |
...
| In Execution ← **Partially Completed** | تسليم بعضه. **ولا الانتقال ولا المتابعة يحدثان في الإصدار الأول** |
| In Execution ← **Failed** | عدم تسليم شيء. **ولا الانتقال ولا المتابعة يحدثان في الإصدار الأول** |
| Partially Completed ← **Completed** | متابعة تُكمل الباقي. **غير قابل للبلوغ في الإصدار الأول** — فلا تُنشأ متابعة |
