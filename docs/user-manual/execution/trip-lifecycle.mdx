...
<Screenshot
  ...
  alt="A SCOP trip form in the Ready to Depart state with its vehicle and driver assigned."
  caption="TRP-2026-000006 the moment the last loading task was settled. Nobody touched the trip — settling the task moved it."
/>
...
<Screenshot
  ...
  alt="A SCOP trip form in the Loading state showing its stops, the assigned vehicle and driver, and the loading tab."
  caption="The same trip while loading is still under way. Depart is not offered here, and will not be until the last task is settled."
/>
...
| Loads → **closed** | |
| **Follow-up demands created** | By design, one per failed line. **Not created in Release 1** — see [Demand Completion](../demand/demand-completion.mdx) |
