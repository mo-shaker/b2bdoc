...
<Screenshot
  ...
  alt="A closed SCOP exception showing its category, root cause, owner, resolution actions and the times it was resolved and closed."
  caption="A closed exception on b2b, with both its resolution actions done and an outcome recorded against each."
/>
