...
```mermaid
flowchart TB
    A["<b>1 · People</b><br/>roles, Odoo groups,<br/><b>two</b> approvers"]
    B["<b>2 · Places</b><br/>planning nodes"]
    C["<b>3 · Capacity</b><br/>profiles → vehicles<br/>→ availability"]
    D["<b>4 · Drivers</b><br/>user + employee<br/>+ the link"]
    E["<b>5 · Vocabularies</b><br/>stop activities,<br/>catalogues if needed"]
    F["<b>6 · Ownership</b><br/>flag, then migrate"]
    G["<b>7 · Switch on</b><br/>pilot scope → Apply"]
    H(["<b>8 · Prove it</b><br/>one transfer,<br/>end to end"])
    A --> B --> C --> D --> E --> F --> G --> H
```
