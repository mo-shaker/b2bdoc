...
<Screenshot
  ...
  alt="A SCOP planning run form showing the provider, provider version, timing and the Request, Response and Rules In Force tabs."
  caption="A planning run on b2b: the baseline provider at version 1.0.0, with its request, its answer and the rules that were in force all retained."
/>
